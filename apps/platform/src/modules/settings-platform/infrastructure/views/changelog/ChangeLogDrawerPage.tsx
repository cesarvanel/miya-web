...
/** Journal des changements — chronologie ancien → nouveau, filtrable par section, lecture seule. Maquette 5a. */
export const ChangeLogDrawerPage: React.FC = () => {
  ...
  return (
    <div className="flex h-full min-w-0 flex-1 items-center justify-center bg-[#F6F5F1]">
      <Drawer isOpen onClose={() => navigate('/settings')} title="Journal des changements" width={420}>
        ...
        {isEmpty && !isPending && <EmptyState title="Aucun changement" description="Les modifications des paramètres apparaîtront ici." />}
