...
/** Écran de connexion de la console éditeur — split-screen sombre, erreur en bannière + shake. */
export const LoginPage: React.FC = () => {
  const { identifier, setIdentifier, password, setPassword, submitting, canSubmit, loginError, attemptId, submit } = useLoginPage();

  return (
    <AuthSplitShell>
      <div className="text-[22px] font-extrabold text-ink">Connexion à la console éditeur</div>
      <div className="mt-1 text-[13px] font-medium text-ink-muted">Accès réservé aux super-administrateurs Miya</div>
