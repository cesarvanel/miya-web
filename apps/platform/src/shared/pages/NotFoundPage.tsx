...
/** Route générique — aucun chemin ne correspond. */
export const NotFoundPage: React.FC = () => {
  const navigate = useNavigate();

  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-cream px-6 text-center">
      <div className="num text-[96px] leading-none font-bold tracking-[-0.03em] text-admin-primary">404</div>
      <div className="my-6.5 h-1.5 w-30 rounded-full bg-admin-primary/20" />
      ...
      <div className="mt-7 flex gap-2.5">
        <Button variant="primary" onClick={() => navigate('/')}>
          Retour à la vue d&rsquo;ensemble
        </Button>
