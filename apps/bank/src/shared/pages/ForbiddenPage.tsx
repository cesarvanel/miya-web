...
/** Rôle non autorisé pour la route courante (RequireRole). Maquette C2. */
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-cream px-6 text-center">
      ...
      <div className="mt-2 max-w-[310px] text-sm leading-[1.55] font-medium text-ink-muted">
        Cette section est réservée aux administrateurs. Contactez votre administrateur si vous pensez qu&rsquo;il s&rsquo;agit d&rsquo;une erreur.
      </div>
      <div className="mt-7">
