...
import { Button, Modal, PasswordField } from '@miya/ui';
import { checkPasswordStrength, PasswordStrengthGauge } from '@/modules/auth';
...
export const ChangePasswordModal: React.FC = () => {
  const { isOpen, close } = useModal('changePassword');
