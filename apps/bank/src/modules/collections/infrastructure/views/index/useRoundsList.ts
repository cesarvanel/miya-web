...
import { selectRoundsOfDay, selectRoundsSummary } from '../../../domain/selectors/Selectors';
...
export const useRoundsList = () => {
  ...
  const summary = useBankSelector(selectRoundsSummary);
  ...
  return { rounds, summary, isPending, goToRound };
};
