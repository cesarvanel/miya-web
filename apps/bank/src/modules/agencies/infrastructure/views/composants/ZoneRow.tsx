...
export const ZoneRow: React.FC<ZoneRowProps> = ({ zone, onAssignAgent }) => {
  const unassigned = !zone.assignedAgentName;

  return (
    <div className="grid grid-cols-[2fr_1.6fr_1fr_1fr_24px] items-center gap-3.5 border-b border-line-soft px-5.5 py-3.5 last:border-b-0">
      ...
      {unassigned ? (
        <button
          ...
          className="flex w-fit cursor-pointer items-center gap-2 rounded-[10px] border-[1.5px] border-dashed border-danger/40 bg-card px-3 py-1.5 text-[12.5px] font-bold text-danger"
        >
