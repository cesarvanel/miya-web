...
import type { SettlementLine } from '../../../domain/entities/SettlementSlip';
...
export const SettlementQueuePage: React.FC = () => {
  ...
  return (
    ...
    >
      <Card padding="none" className="w-95">
          ...
          {queue.map((slip) => {
            ...
            return (
              <Link
                ...
                className="block rounded-2xl border border-line bg-card p-3.25 transition hover:border-primary/40"
              >
